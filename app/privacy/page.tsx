   ...
   return (
      <div className="min-h-screen bg-[#07091A] text-[#CBD5E1]">
         <div className="max-w-3xl mx-auto px-6 py-16">
            ...
            <div className="prose-policy space-y-8 text-sm leading-relaxed">
               <section>
                  <h2 className="text-base font-semibold text-white mb-3">1. Общие положения</h2>
                  <p>
                     ...
                     предпринимаемые Слуцкий Михаил Александрович (далее - Оператор).
                  </p>
                  <p className="mt-3">
                  ...
                  <p className="mt-3">
                     ...
                     <a href="https://linkedhire.io/" className="text-[#3B82F6] hover:underline">
                        https://linkedhire.io/
                     </a>
                     .
                  </p>
               ...
               <section>
                  ...
                  <div className="space-y-1 pl-4">
                     ...
                     <p>
                        ...
                        данных по запросу этого органа необходимую информацию в течение 10 дней с
               ...
               <section>
                  ...
                  <div className="border border-[#1B2847] rounded-xl overflow-hidden text-sm">
                     <div className="grid grid-cols-[auto_1fr] divide-x divide-[#1B2847]">
                        <div className="px-4 py-3 text-[#94A3B8] font-medium bg-[#0D1426] whitespace-nowrap">
                           Цель обработки
                        </div>
                     ...
                     <div className="border-t border-[#1B2847] grid grid-cols-[auto_1fr] divide-x divide-[#1B2847]">
                        <div className="px-4 py-3 text-[#94A3B8] font-medium bg-[#0D1426] whitespace-nowrap">
                           Персональные данные
                        </div>
                        <div className="px-4 py-3">электронный адрес</div>
                     </div>
                     <div className="border-t border-[#1B2847] grid grid-cols-[auto_1fr] divide-x divide-[#1B2847]">
                        <div className="px-4 py-3 text-[#94A3B8] font-medium bg-[#0D1426] whitespace-nowrap">
                           Правовые основания
               ...
               <section>
                  ...
                  <div className="space-y-2">
                     ...
                     <p>
                        ...
                        Интернет по адресу{" "}
                        <a
                           href="https://linkedhire.io/privacy"
                           className="text-[#3B82F6] hover:underline"
                        >
                           https://linkedhire.io/privacy
                        </a>
                        .
                     </p>
                  </div>
