...
export default function Hero() {
   return (
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
         ...
         <div className="relative max-w-6xl mx-auto py-10 w-full px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
               ...
               <div>
                  ...
                  <div className="anim-5 flex items-center gap-3 text-sm text-[#64748B]">
                     ...
                     <span>
                        <span className="text-white font-semibold">500+</span> разработчиков уже
                        получают отклики с новым профилем
                     </span>
                  </div>
               </div>
                     ...
                     <div className="card p-6 rounded-2xl relative overflow-hidden">
                        ...
                        <div className="relative">
                           ...
                           <div className="flex flex-wrap gap-2">
                              {["Python", "Django", "FastAPI", "PostgreSQL", "Remote"].map(
                                 (skill) => (
                                    <span
                                       key={skill}
