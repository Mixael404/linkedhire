...
const comparisons = [
   {
      ...
      after: "Senior Backend Engineer · Python & Django · Fintech APIs | Open to Remote EU/US",
   ...
   },
   {
      ...
      after: "Backend Engineer with 5+ years building scalable fintech APIs. Shipped systems processing $2M+ daily transactions. Proficient in Python, Django, FastAPI. Open to senior remote roles in EU/US fintech.",
      note: "Результаты + цифры + специализация + целевой рынок",
   },
   {
      section: "Experience",
      before: "Разрабатывал бэкенд для сервиса. Участвовал в проектировании архитектуры.",
         ...
         <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-14">
               ...
               <p className="text-[#64748B] text-lg max-w-xl mx-auto">
                  Вот как выглядит профиль до и после оптимизации LinkedHire. Это не магия - это
                  ...
                  <div key={c.section}>
                     ...
                     <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div className="before-card p-5">
                           ...
                           <p className="text-[#94A3B8] text-sm leading-relaxed">{c.before}</p>
                        </div>
