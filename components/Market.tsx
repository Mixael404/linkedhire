...
const stats = [
   {
      ...
      flag: <Flags.US title="United States" className="inline-block w-6 h-4" />,
   },
   {
      value: "€70K",
      label: "средний оффер мидл-разработчика в Германии",
      sub: "плюс соцпакет и отпуск 30 дней",
      flag: <Flags.DE title="Germany" className="inline-block w-6 h-4" />,
   },
   {
      value: "3×",
...
export default function Market() {
   return (
      <section id="market" className="py-10 relative bg-[#0A0D1F]">
         ...
         <div className="relative max-w-6xl mx-auto px-6">
            <div className="text-center mb-14">
               <span className="section-label mb-4 inline-flex">Почему международный рынок</span>
               <h2
               ...
               <p className="text-[#64748B] text-lg max-w-xl mx-auto">
                  Международный рынок труда для разработчиков открыт. Вопрос только в том, как ты
                  себя представляешь.
               </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
               {stats.map((s) => (
                  ...
                  >
                     ...
                     <div className="stat-number text-4xl font-black mb-2">{s.value}</div>
            ...
            <div className="mt-12 p-8 rounded-2xl border border-[#1B2847] bg-[#0D1426]">
               <p
               ...
               <p className="text-[#94A3B8] text-base leading-relaxed max-w-2xl">
                  Проблема не в том, что туда невозможно попасть. Проблема в том, что LinkedIn и CV
                  должны быть оформлены по правилам этого рынка.
               </p>
            </div>
