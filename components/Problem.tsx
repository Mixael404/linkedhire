         ...
         <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="text-center mb-14">
               ...
               <p className="text-[#94A3B8] text-lg max-w-2xl mx-auto leading-relaxed">
                  Российский IT-рынок переживает структурный кризис. Если ты отправляешь резюме на
                  hh.ru и не получаешь ответов - это не твоя вина. Это системная проблема рынка, с
                  которой столкнулись тысячи разработчиков.
               </p>
            </div>
            ...
            <div className="card p-8 mb-10">
               ...
               <div className="grid sm:grid-cols-2 gap-6 text-[#94A3B8] text-sm leading-relaxed">
                  <p>
                     Если ты разработчик с реальным опытом - React, Python, Java, Go, DevOps - и всё
                     равно не можешь найти нормальную работу в IT, это не потому что ты недостаточно
                     хорош. Российский рынок IT объективно стал тесным: меньше вакансий, больше
                     кандидатов, ниже бюджеты на найм.
                  </p>
                  <p>
            ...
            <div className="p-8 rounded-2xl border border-[#2563EB]/30 bg-linear-to-br from-[#2563EB]/8 to-[#06B6D4]/5 text-center">
               ...
               <p className="text-[#64748B] text-sm mt-3 max-w-xl mx-auto">
                  Удалённая работа в IT за рубежом - это не мечта о переезде. Это рабочая
                  альтернатива, которую выбирают тысячи разработчиков из России, Беларуси и
                  Казахстана прямо сейчас.
               </p>
               <a
                  href="#market"
