...
export const GOAL_OPTIONS = [
   ...
   {
      value: "recruiter_responses",
      label: "Хочу выйти на удалёнку за границей, но не понимаю с чего начать",
   },
               ...
               {GOAL_OPTIONS.map((opt) => {
                  ...
                  return (
                     <button
                        ...
                        type="button"
                        onClick={() =>
                           setValue("goal", isSelected ? "" : opt.value, { shouldValidate: true })
                        }
                  ...
                  ${isSelected ? "border-[#2563EB] bg-[#2563EB]" : "border-[#475569]"}`}
                        ...
                        <span
                           className={`text-sm font-medium transition-colors ${isSelected ? "text-white" : "text-[#94A3B8]"}`}
                        >
                           {opt.label}
                        </span>
               ...
               {APPLICATIONS_OPTIONS.map((opt) => {
                  ...
                  return (
                     <button
                        ...
                        type="button"
                        onClick={() =>
                           setValue("applicationsCount", isSelected ? "" : opt.value, {
                              shouldValidate: true,
                           })
                        }
