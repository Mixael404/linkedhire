...
const inputCls =
   "w-full bg-[#07091A] border border-[#1B2847] focus:border-[#2563EB] rounded-lg px-3 py-2.5 text-white text-sm outline-none transition-colors placeholder:text-[#475569]";
const inputErrCls =
   "w-full bg-[#07091A] border border-red-500/60 focus:border-red-500 rounded-lg px-3 py-2.5 text-white text-sm outline-none transition-colors placeholder:text-[#475569]";
...
function CharCount({ current, max }: { current: number; max: number }) {
   ...
   return (
      <span
         className={`absolute bottom-2.5 right-3 text-[10px] pointer-events-none select-none tabular-nums ${color}`}
      >
         {current}/{max}
      </span>
   );
   ...
   return (
      <div className={`relative ${className}`}>
         ...
         >
            ...
            <HiChevronDown
               size={13}
               className={`text-[#64748B] transition-transform duration-150 shrink-0 ${open ? "rotate-180" : ""}`}
            />
         </button>
            ...
            <div className="px-5 pb-6 pt-5 space-y-6">
               ...
               <div>
                  <div className="flex items-center justify-between mb-1.5">
                     ...
                     <span
                        className={`text-[10px] tabular-nums ${tasks.length >= MAX_TASKS ? "text-amber-400" : "text-[#3B4A6B]"}`}
                     >
               ...
               <div>
                  <div className="flex items-center justify-between mb-1.5">
                     ...
                     <span
                        className={`text-[10px] tabular-nums ${isSkillsAtLimit ? "text-amber-400" : "text-[#3B4A6B]"}`}
                     >
               ...
               <div>
                  <div className="flex items-center justify-between mb-1.5">
                     ...
                     {!needsHelp && (
                        <span
                           className={`text-[10px] tabular-nums ${achievements.length >= MAX_ACHIEVEMENTS ? "text-amber-400" : "text-[#3B4A6B]"}`}
                        >
                  ...
                  {projectOpen && (
                     <div className="mt-4 space-y-4">
                        <p className="text-[#475569] text-xs leading-relaxed -mt-1">
                           Заполни, если хочешь показать этот опыт как отдельный проект - например,
                           фриланс, побочный проект или важный внутренний инструмент.
                        </p>
                           ...
                           <div>
                              ...
                              <SelectField
                                 ...
                                 onChange={(v) =>
                                    setValue(
                                       `${base}.projectType`,
                                       v as WorkExperience["projectType"],
                                    )
                                 }
                                 options={[
                                    {
                           ...
                           <div>
                              ...
                              <SelectField
                                 ...
                                 onChange={(v) =>
                                    setValue(
                                       `${base}.projectRole`,
                                       v as WorkExperience["projectRole"],
                                    )
                                 }
                                 options={[
