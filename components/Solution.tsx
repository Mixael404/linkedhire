...
const features: { icon: ReactNode; title: string; desc: string }[] = [
   {
      ...
      desc: "Один раз описываешь опыт - мы понимаем, кто ты как специалист и в чём твоя ценность.",
   },
   {
      icon: <HiPencilSquare size={22} />,
      title: "Создаём сильный профиль",
      desc: "Headline, About, Experience, Рекомендации - всё переписываем под международные стандарты на языке, который понимают рекрутеры.",
   },
   {
         ...
         <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-14">
               ...
               <p className="text-[#64748B] text-lg max-w-xl mx-auto">
                  LinkedHire - это не просто редактор. Это полный пайплайн превращения твоего опыта
                  в международный LinkedIn-профиль.
               </p>
            </div>
